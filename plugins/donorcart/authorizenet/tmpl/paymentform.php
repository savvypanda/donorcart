...
<?php } elseif($allow_recurring_donations==2) {
	...
	<?php } else {
		...
		<div class="field select">
			<label for="<?=$this->getName()?>_payment_frequency"><?=JText::_('PLG_DONORCART_AUTHORIZENET_RECURRING_FREQUENCY_LABEL')?>: </label>
	...
	<?php
		...
		<div class="field select" id="dcart-donatelinq-frequencyouter">
			<label for="dcart-donatelinq-frequencyselector"><?=JText::_('PLG_DONORCART_AUTHORIZENET_RECURRING_FREQUENCY_LABEL')?>: </label>
...
<p><small><em><?=JText::_('PLG_DONORCART_AUTHORIZENET_REDIRECT_AFTER_CONFIRM')?></em></small></p>